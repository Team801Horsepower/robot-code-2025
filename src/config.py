...
pivot_pid_constants: List[Tuple[float, ...]] = format_table([
    ...
    (0.7366, 100 * 0.65, 0, 0),
    (0.9165968599, 100 * 0.6, 0, 0),
    (1.276590580, 100 * 0.55, 0, 0),
    (1.636584300, 110 * 0.5, 0, 0),
...
elevator_dynamics_table: List[Tuple[float, ...]] = format_table([
    (0.7366, 80 * 0.00263556269000882, 0),
    (0.9165968599, 100 * 0.00299495760228274, 0),
    (1.096593740, 100 * 0.00347415081864798, 0),
    (1.276590580, 100 * 0.00407314233910454, 0),
    (1.456587440, 100 * 0.00443253725137846, 0),
    (1.91, 70 * 0.0065, 0),
])
# fmt: on
